...
const ScrollToTopFab = () => {
  ...
  return (
    <div
      ...
      class="hover:cursor-pointer fixed bottom-5 right-5 lg:right-25 xl:right-40 z-10000 background-white shadow-xl rounded-full p-6 bg-white dark:bg-gray-800 border-gray-300 dark:border-gray-600 border-2"
    >
